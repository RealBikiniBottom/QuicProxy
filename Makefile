...
build-android:
	...
	cargo ndk -t arm64-v8a -t armeabi-v7a -o ./src/premium/quicproxy_flutter/android/app/src/main/jniLibs rustc --release --features "jni,premium" --lib -- --crate-type cdylib
